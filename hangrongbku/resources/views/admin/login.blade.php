				...
				<div class="graphs">
					<div class="sign-in-form">
						...
						<div class="signin">
							...
							<form method ="post" action="{{route('admin.login.postAdminLogin')}}">
							<div class="log-input">
								<div class="log-input-left">
								   <input name="email" type="text" class="user" value="Yourname" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email address:';}"/>
								</div>
							...
							<div class="log-input">
								<div class="log-input-left">
								   <input name="pass" type="password" class="lock" value="password" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email address:';}"/>
								</div>
								<span class="checkbox2">
									 <label class="checkbox"><input type="checkbox" name="checkbox" checked=""><i> </i></label>
								</span>
